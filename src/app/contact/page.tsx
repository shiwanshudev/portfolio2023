...
export default function Contact() {
  ...
  return (
    <div className="mx-auto container text-center px-5 pt-28 lg:px-48 lg:pt-24 animate-fade-in">
      ...
      >
        <fieldset className="w-80">
          <legend className="pb-2 text-xl text-indigo-200 font-prompt">
            Schedule a call
          </legend>{" "}
          <div>
            <label
            ...
            <input
              ...
              className=" outline-none bg-indigo-900 rounded-md px-2 py-2 placeholder-indigo-500 w-full"
