    ...
    <div className="mx-auto container text-center px-5 lg:px-48 lg:text-left">
      <section className="pt-20">
        ...
        <div className="pt-5 flex flex-col items-center justify-center">
          ...
          >
            <div className="flex items-center justify-center bg-purple-900 py-3 px-5 rounded-md flex-col duration-300 border-solid border border-purple-500 hover:bg-purple-800 mb-2 lg:flex-row">
              <div className="w-full lg:w-3/12 h-52 lg:h-28 relative lg:mr-5">
                <Image
                  src={"/images/project1.png"}
                  alt="Portfolio Website Project"
                  className="border-solid border border-purple-500 rounded-md object-cover"
                  fill={true}
                />
              </div>
              <div className=" w-full lg:w-9/12">
                <h2 className="text-lg lg:text-2xl font-bold text-purple-400 pt-3 lg:pt-0">
                  Portfolio Website
                </h2>
